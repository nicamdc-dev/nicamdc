!-------------------------------------------------------------------------------
!
!+  Module of initial condition for DCMIP-2012
!
!-------------------------------------------------------------------------------
module mod_dcmip
  !
  !  Original name was "dcmip_initial_conditions_test_1_2_3"
  !=======================================================================
  !
...
!-----------------------------------------------------------------------
	...
	elseif (cfv .eq. 1) then
		...
		call test1_adv_orog_hybeta_vel(w)
	...
	elseif (cfv .eq. 2) then
		...
		call test1_adv_orog_GalChen_vel(w)	
...
!-----------------------------------------------------------------------
	...
	SUBROUTINE test1_adv_orog_hybeta_vel(w)
	IMPLICIT NONE
	real(8), intent(out) ::	w
	...
	END SUBROUTINE test1_adv_orog_hybeta_vel
	...
	SUBROUTINE test1_adv_orog_GalChen_vel(w)
	IMPLICIT NONE
	real(8), intent(out) ::	w
	...
	END SUBROUTINE test1_adv_orog_GalChen_vel
