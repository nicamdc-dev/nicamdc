...
module mod_const
  ...
  real(RP), public            :: CONST_LHV0    = 2.5008E6_RP         !< latent heat of vaporizaion at 0C [J/kg]
  real(RP), public            :: CONST_LHV00                         !< latent heat of vaporizaion at 0K [J/kg]
  real(RP), public            :: CONST_LHS0    = 2.8342E6_RP         !< latent heat of sublimation at 0C [J/kg]
