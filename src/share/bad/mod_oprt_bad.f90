...
contains
  ...
  subroutine OPRT_diffusion( &
    ...
    integer :: nstart, nend
    integer :: nstart1, nstart2, nstart3
    ...
    do l = 1, ADM_lall
       ...
       do n = nstart, nend
          ...
          u1 = - cmdif_T(ADM_TI,n,l) * ( 0.5D0 * (scl(ij    ,k,l)+scl(ip1j  ,k,l)) - smean )
          u2 = - cmdif_T(ADM_TI,n,l) * ( 0.5D0 * (scl(ip1j  ,k,l)+scl(ip1jp1,k,l)) - smean )
          u3 = + cmdif_T(ADM_TI,n,l) * ( 0.5D0 * (scl(ip1jp1,k,l)+scl(ij    ,k,l)) - smean )

          vxt(n,k,l,ADM_TI) = u1 * cmdif_AT(ADM_AI ,1,ij  ,l) &
                            + u2 * cmdif_AT(ADM_AJ ,1,ip1j,l) &
                            + u3 * cmdif_AT(ADM_AIJ,1,ij  ,l)
          vyt(n,k,l,ADM_TI) = u1 * cmdif_AT(ADM_AI ,2,ij  ,l) &
                            + u2 * cmdif_AT(ADM_AJ ,2,ip1j,l) &
                            + u3 * cmdif_AT(ADM_AIJ,2,ij  ,l)
          vzt(n,k,l,ADM_TI) = u1 * cmdif_AT(ADM_AI ,3,ij  ,l) &
                            + u2 * cmdif_AT(ADM_AJ ,3,ip1j,l) &
                            + u3 * cmdif_AT(ADM_AIJ,3,ij  ,l)

          smean = ( scl(ij    ,k,l) &
                  + scl(ip1jp1,k,l) &
                  + scl(ijp1  ,k,l) ) / 3.D0

          u1 = - cmdif_T(ADM_TJ,n,l) *( 0.5D0 * (scl(ij    ,k,l)+scl(ip1jp1,k,l)) - smean )
          u2 = + cmdif_T(ADM_TJ,n,l) *( 0.5D0 * (scl(ip1jp1,k,l)+scl(ijp1  ,k,l)) - smean )
          u3 = + cmdif_T(ADM_TJ,n,l) *( 0.5D0 * (scl(ijp1  ,k,l)+scl(ij    ,k,l)) - smean )

          vxt(n,k,l,ADM_TJ) = u1 * cmdif_AT(ADM_AIJ,1,ij  ,l) &
                            + u2 * cmdif_AT(ADM_AI ,1,ijp1,l) &
                            + u3 * cmdif_AT(ADM_AJ ,1,ij  ,l)
          vyt(n,k,l,ADM_TJ) = u1 * cmdif_AT(ADM_AIJ,2,ij  ,l) &
                            + u2 * cmdif_AT(ADM_AI ,2,ijp1,l) &
                            + u3 * cmdif_AT(ADM_AJ ,2,ij  ,l)
          vzt(n,k,l,ADM_TJ) = u1 * cmdif_AT(ADM_AIJ,3,ij  ,l) &
                            + u2 * cmdif_AT(ADM_AI ,3,ijp1,l) &
                            + u3 * cmdif_AT(ADM_AJ ,3,ij  ,l)
       enddo
       enddo
    ...
    if ( ADM_prc_me == ADM_prc_pl ) then
       ...
       do ij = ADM_GMIN_PL, ADM_GMAX_PL
          ...
          smean = ( scl_pl(n   ,k,l) &
                  + scl_pl(ij  ,k,l) &
                  + scl_pl(ijp1,k,l) ) / 3.D0

          u1 = + GMTR_T_var_pl(ij,K0,l,RAREA) * ( 0.5D0 * (scl_pl(n   ,k,l)+scl_pl(ij  ,k,l)) - smean )
          u2 = + GMTR_T_var_pl(ij,K0,l,RAREA) * ( 0.5D0 * (scl_pl(ij  ,k,l)+scl_pl(ijp1,k,l)) - smean )
          u3 = - GMTR_T_var_pl(ij,K0,l,RAREA) * ( 0.5D0 * (scl_pl(ijp1,k,l)+scl_pl(n   ,k,l)) - smean )

          vxt_pl(n,k,l) = u1 * GMTR_A_var_pl(ij  ,K0,l,GMTR_A_TNX ) &
                        + u2 * GMTR_A_var_pl(ij  ,K0,l,GMTR_A_TN2X) &
                        + u3 * GMTR_A_var_pl(ijp1,K0,l,GMTR_A_TNX )
          vyt_pl(n,k,l) = u1 * GMTR_A_var_pl(ij  ,K0,l,GMTR_A_TNY ) &
                        + u2 * GMTR_A_var_pl(ij  ,K0,l,GMTR_A_TN2Y) &
                        + u3 * GMTR_A_var_pl(ijp1,K0,l,GMTR_A_TNY )
          vzt_pl(n,k,l) = u1 * GMTR_A_var_pl(ij  ,K0,l,GMTR_A_TNZ ) &
                        + u2 * GMTR_A_var_pl(ij  ,K0,l,GMTR_A_TN2Z) &
                        + u3 * GMTR_A_var_pl(ijp1,K0,l,GMTR_A_TNZ )
       enddo
       enddo
       enddo
    endif
    ...
    do l = 1, ADM_lall
       ...
       do k = 1, ADM_kall
          do n = nstart1, nend
             ...
             flux(n,ADM_AI ) = ( ( vxt(ijm1,k,l,ADM_TJ)+vxt(ij  ,k,l,ADM_TI) ) * cmdif_AH(ADM_AI ,1,n,l) &
                               + ( vyt(ijm1,k,l,ADM_TJ)+vyt(ij  ,k,l,ADM_TI) ) * cmdif_AH(ADM_AI ,2,n,l) &
                               + ( vzt(ijm1,k,l,ADM_TJ)+vzt(ij  ,k,l,ADM_TI) ) * cmdif_AH(ADM_AI ,3,n,l) &
                               ) * 0.5D0 * ( kh(ij,k,l)+kh(ip1j  ,k,l) ) * 0.5D0

             flux(n,ADM_AIJ) = ( ( vxt(ij  ,k,l,ADM_TI)+vxt(ij  ,k,l,ADM_TJ) ) * cmdif_AH(ADM_AIJ,1,n,l) &
                               + ( vyt(ij  ,k,l,ADM_TI)+vyt(ij  ,k,l,ADM_TJ) ) * cmdif_AH(ADM_AIJ,2,n,l) &
                               + ( vzt(ij  ,k,l,ADM_TI)+vzt(ij  ,k,l,ADM_TJ) ) * cmdif_AH(ADM_AIJ,3,n,l) &
                               ) * 0.5D0 * ( kh(ij,k,l)+kh(ip1jp1,k,l) ) * 0.5D0

             flux(n,ADM_AJ ) = ( ( vxt(ij  ,k,l,ADM_TJ)+vxt(ijm1,k,l,ADM_TI) ) * cmdif_AH(ADM_AJ ,1,n,l) &
                               + ( vyt(ij  ,k,l,ADM_TJ)+vyt(ijm1,k,l,ADM_TI) ) * cmdif_AH(ADM_AJ ,2,n,l) &
                               + ( vzt(ij  ,k,l,ADM_TJ)+vzt(ijm1,k,l,ADM_TI) ) * cmdif_AH(ADM_AJ ,3,n,l) &
                               ) * 0.5D0 * ( kh(ij,k,l)+kh(ijp1  ,k,l) ) * 0.5D0
          enddo

          do n = nstart2, nstart1-1
             flux(n,ADM_AIJ) = ( ( vxt(ij  ,k,l,ADM_TI)+vxt(ij  ,k,l,ADM_TJ) ) * cmdif_AH(ADM_AIJ,1,n,l) &
                               + ( vyt(ij  ,k,l,ADM_TI)+vyt(ij  ,k,l,ADM_TJ) ) * cmdif_AH(ADM_AIJ,2,n,l) &
                               + ( vzt(ij  ,k,l,ADM_TI)+vzt(ij  ,k,l,ADM_TJ) ) * cmdif_AH(ADM_AIJ,3,n,l) &
                               ) * 0.5D0 * ( kh(ij,k,l)+kh(ip1jp1,k,l) ) * 0.5D0
          enddo
          do n = nstart3, nstart1-1
             flux(n,ADM_AJ ) = ( ( vxt(ij  ,k,l,ADM_TJ)+vxt(im1j,k,l,ADM_TI) ) * cmdif_AH(ADM_AJ, 1,n,l) &
                               + ( vyt(ij  ,k,l,ADM_TJ)+vyt(im1j,k,l,ADM_TI) ) * cmdif_AH(ADM_AJ, 2,n,l) &
                               + ( vzt(ij  ,k,l,ADM_TJ)+vzt(im1j,k,l,ADM_TI) ) * cmdif_AH(ADM_AJ, 3,n,l) &
                               ) * 0.5D0 * ( kh(ij,k,l)+kh(ijp1  ,k,l) ) * 0.5D0
          enddo

          do n = nstart, nend
             dscl(n,k,l) = ( flux(ij    ,ADM_AI ) &
                           + flux(ij    ,ADM_AIJ) &
                           + flux(ij    ,ADM_AJ ) &
                           - flux(im1j  ,ADM_AI ) &
                           - flux(im1jm1,ADM_AIJ) &
                           - flux(ijm1  ,ADM_AJ ) ) * cmdif_P(n,l) * fact
          enddo
       enddo
       ...
       if ( ADM_rgn_vnum(ADM_W,rgnid) == 3 ) then
          ...
          do k = 1, ADM_kall
             dscl(ij,k,l) = ( flux(ij    ,ADM_AI ) &
                            + flux(ij    ,ADM_AIJ) &
                            + flux(ij    ,ADM_AJ ) &
                            - flux(im1j  ,ADM_AI ) &
                            - flux(im1jm1,ADM_AIJ) ) * GMTR_P_var(ij,K0,l,RAREA) * fact
          enddo
       endif
    enddo
    ...
    if ( ADM_prc_me == ADM_prc_pl ) then
       ...
       do k = 1, ADM_kall
          ...
          do ij = ADM_GMIN_PL, ADM_GMAX_PL
             ...
             flux_pl = ( ( vxt_pl(ijm1,k,l)+vxt_pl(ij,k,l) ) * GMTR_A_var_pl(ij,K0,l,GMTR_A_HNX) &
                       + ( vyt_pl(ijm1,k,l)+vyt_pl(ij,k,l) ) * GMTR_A_var_pl(ij,K0,l,GMTR_A_HNY) &
                       + ( vzt_pl(ijm1,k,l)+vzt_pl(ij,k,l) ) * GMTR_A_var_pl(ij,K0,l,GMTR_A_HNZ) &
                       ) * 0.5D0 * ( kh_pl(n,k,l)+kh_pl(ij,k,l) ) * 0.5D0

             dscl_pl(n,k,l) = dscl_pl(n,k,l) + flux_pl
          enddo
          dscl_pl(n,k,l) = dscl_pl(n,k,l) * GMTR_P_var_pl(n,K0,l,RAREA) * fact
  ...
  subroutine OPRT_divdamp(       &
    ...
    real(8) :: sclt   (ADM_gall,   ADM_kall,ADM_lall,  ADM_TI:ADM_TJ)
    real(8) :: sclt_pl(ADM_gall_pl,ADM_kall,ADM_lall_pl)
